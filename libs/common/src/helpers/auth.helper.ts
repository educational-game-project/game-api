...
export class AuthHelper {
    ...
    public validateToken(token: string) {
        const decoded = this.jwt.verify(token, { secret: this.configService.get('JWT_SECRET'), });
        return decoded;
    }
    ...
    // Generate JWT Token
    public async generateTokens(userId: Types.ObjectId, data: { role: string, email?: string, phoneNumber?: string }) {
