export const dateToString = [
    ...
    {
        $set: {
            createdAtString: { $concat: [{ $toString: "$day" }, " ", "$month", " ", { $toString: "$year" }, " ", "$time"] }
        }
    },
    {
        $set: {
            ...
            timeUpdatedAt: { $dateToString: { format: "%H:%M:%S", date: "$updatedAt" } },
        }
    },
    {
        $set: {
            updatedAtString: { $concat: [{ $toString: "$dayUpdatedAt" }, " ", "$monthUpdatedAt", " ", { $toString: "$yearUpdatedAt" }, " ", "$timeUpdatedAt"] }
        }
    },
    {
        $unset: ['day', 'month', 'year', 'dayUpdatedAt', 'monthUpdatedAt', 'yearUpdatedAt', 'timeUpdatedAt', 'time']
    },
]